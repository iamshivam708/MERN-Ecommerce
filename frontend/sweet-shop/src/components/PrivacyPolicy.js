  ...
  render() {
    ...
    <div className="privacy">
        ...
        <div class="px-4 py-5 my-3 text-center">
            ...
            <h1 class="display-5 fw-bold"><span style={{color:'orange'}}>Privacy</span> Policy</h1>
        </div>
        </div>
      <div className="container mt-4 mb-4" style={{lineHeight:"2em"}}>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to SweetShop.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to SweetShop, accessible from{" "}
              <a
                href="localhost:3000"
